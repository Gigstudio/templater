...
<nav id="mainmenu" class="part main-menu">
    <div class="row">
        ...
        <div class="menu-holder" id="main_links">
            <a class="menu-item<?=$active[0] ? ' selected' : '' ?>" href="<?=HOME_URL.'plans'?>" id="plans"><span>Пользователи</span></a>
            <a class="menu-item<?=$active[1] ? ' selected' : '' ?>" href="<?=HOME_URL.'startuse'?>" id="startuse"><span>Публикации</span></a>
            <a class="menu-item<?=$active[2] ? ' selected' : '' ?>" href="<?=HOME_URL.'about'?>" id="about"><span>Сайт</span></a>
        </div>
    </div>
</nav>